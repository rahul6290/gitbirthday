    ...
    const sound2=new Audio("hbd2.mp3")
    ...
    checkBtn.addEventListener('click' ,function(){
        ...
        if(value=='1'){
            ...
            divEl.textContent="You are the best gift, I've ever been gifted with , may be as a friend or may be something else but I mean it, and I really do. ";
       para.textContent="Good Job again!!👌👌";
    }
    else if(value=='6'){
        ...
        divEl.textContent=" Happy Birthday To You, Happy Birthday To You, Happy Birthday Tooo Debasmiiiita ,Happy Birthday To You. Now probably you searched for 9 and came to almost end of my tiny surprise, look I just have expressed as much poetic lines as I knew, if you like this tiny effort , not only this but my each and every effort will be worth making. So, Debasmita Roy I hope you liked it.";
